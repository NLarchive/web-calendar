...
export function renderWeekView(items, rangeStart) {
  ...
  const html = days
    .map((day) => {
      ...
      return `
      <div class="calendar-day hierarchy-cell" data-nav-target="day" data-focus-date="${focusIso}" role="button" tabindex="0" aria-label="Open day view for ${day.toLocaleDateString()}">
